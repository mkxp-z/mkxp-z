...
if(WIN32)
  if (MSVC)
    ...
    set(_Ruby_POSSIBLE_MINGW_RUNTIMES "ucrt;")
    ...
    foreach(_Ruby_MINGW_RUNTIME ${_Ruby_POSSIBLE_MINGW_RUNTIMES})
      foreach(_Ruby_VERSION_SUFFIX ${_Ruby_POSSIBLE_VERSION_SUFFICES})
        list(APPEND _Ruby_POSSIBLE_LIB_NAMES
                "lib${_Ruby_ARCH_PREFIX}${_Ruby_MINGW_RUNTIME}-ruby${_Ruby_VERSION_SUFFIX}"
                "lib${_Ruby_ARCH_PREFIX}${_Ruby_MINGW_RUNTIME}-ruby${_Ruby_VERSION_SUFFIX}-static"
                "${_Ruby_ARCH_PREFIX}${_Ruby_MINGW_RUNTIME}-ruby${_Ruby_VERSION_SUFFIX}"
                "${_Ruby_ARCH_PREFIX}${_Ruby_MINGW_RUNTIME}-ruby${_Ruby_VERSION_SUFFIX}-static")
      endforeach()
    endforeach()
  endif()
endif()
